...
func renderedText(cells []Cell, cursorCol, selStart, selEnd, startCol, maxWidth int) string {
	raw := RenderCellsWithPalette(cells, cursorCol, selStart, selEnd, nil, [2]int{-1, -1}, startCol, maxWidth, theme.Palette{}, nil, 0)
...
func TestRenderCells_CursorWithOffset(t *testing.T) {
	...
	raw := RenderCellsWithPalette(cells, 5, -1, -1, nil, [2]int{-1, -1}, 3, 5, pal, nil, 0)
...
func TestRenderCells_CursorOutOfViewport(t *testing.T) {
	...
	raw := RenderCellsWithPalette(cells, 2, -1, -1, nil, [2]int{-1, -1}, 5, 5, pal, nil, 0)
...
func TestRenderCells_SelectionWithOffset(t *testing.T) {
	...
	raw := RenderCellsWithPalette(cells, -1, 3, 6, nil, [2]int{-1, -1}, 2, 6, pal, nil, 0)
