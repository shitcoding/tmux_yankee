...
build_yankee_args() {
    ...
    opt_map=(
        ...
        "@yankee_gutter_separator_bg"      "--gutter-separator-bg"
        "@yankee_gutter_separator_char"    "--gutter-separator-char"
        "@yankee_linenum_absolute_bold"    "--linenum-absolute-bold"
        "@yankee_linenum_absolute_dim"     "--linenum-absolute-dim"
        "@yankee_linenum_absolute_italic"  "--linenum-absolute-italic"
        "@yankee_linenum_relative_bold"    "--linenum-relative-bold"
        "@yankee_linenum_relative_dim"     "--linenum-relative-dim"
        "@yankee_linenum_relative_italic"  "--linenum-relative-italic"
        "@yankee_linenum_cursor_dim"       "--linenum-cursor-dim"
        "@yankee_linenum_cursor_italic"    "--linenum-cursor-italic"
        "@yankee_status_bold"              "--status-bold"
        "@yankee_status_dim"               "--status-dim"
        "@yankee_cursor_dim"               "--cursor-dim"
        "@yankee_cursor_italic"            "--cursor-italic"
        "@yankee_selection_dim"            "--selection-dim"
        "@yankee_selection_italic"         "--selection-italic"
